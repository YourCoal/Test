...
//		}
		...
		if (iv == null) {
			...
			CivMessage.global(CivColor.LightGray+player.getName()+" attempted to be validated by anti-cheat, but has an illegal mod!");
			return;
		}
		...
		try {
			...
			CivMessage.global(CivColor.LightGray+player.getName()+" is verified by anti-cheat.");
			return;
		} catch (CivException e) {
