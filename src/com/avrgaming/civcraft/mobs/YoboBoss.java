...
public class YoboBoss extends CommonCustomMob implements ICustomMob {
	...
	public void onCreateAttributes() {
		...
		zombie.getAttributeInstance(GenericAttributes.maxHealth).setValue(2500.0D);
		zombie.getAttributeInstance(GenericAttributes.c).setValue(1.0D);
		zombie.getAttributeInstance(GenericAttributes.c).setValue(2000.0D);
		//AttributeModifier mod = new AttributeModifier()
		zombie.setHealth(2500.0f);
	}
