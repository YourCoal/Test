...
public class Buff {
	...
	public static final String DEBUFF_PYRAMID_LEECH = "debuff:pyramid_leech";
	public static final String POLISHING = "buff:polishing";
	public static final String MATURING = "buff:maturing";
	public static final String EFFICIENCY = "buff:efficiency";
