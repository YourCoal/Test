...
public class GreatLibrary extends Wonder {
	...
	protected void removeBuffs() {
		this.removeBuffFromCiv(this.getCiv(), "buff:greatlibrary_extra_beakers");
		this.removeBuffFromTown(this.getTown(), "buff:greatlibrary_double_tax_beakers");
	}

	@Override
	protected void addBuffs() {
		this.addBuffToCiv(this.getCiv(), "buff:greatlibrary_extra_beakers");
		this.addBuffToTown(this.getTown(), "buff:greatlibrary_double_tax_beakers");
	}
